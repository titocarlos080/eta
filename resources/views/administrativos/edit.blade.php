    ...
    <div class="container-fluid p-4">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Editar Administrativo</h3>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nombre" id="nombre" class="form-control" value="{{ $administrativo->nombre }}" required>
                                @error('nombre')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="apellido_pat" id="apellido_pat" class="form-control" value="{{ $administrativo->apellido_pat }}" required>
                                @error('apellido_pat')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="apellido_mat" id="apellido_mat" class="form-control" value="{{ $administrativo->apellido_mat }}" required>
                                @error('apellido_mat')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
